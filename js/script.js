...
document.addEventListener('DOMContentLoaded', () => {
    ...
    description_text.textContent = "This app is a web counter; you can increase or decrease the number below by clicking on + or -, and the count will be modified by the step you select (the default step is one). The step is only valid when it is an integer between 1 and 100. You can also reset the counter to zero by cliking on the the prompt below."
